...
x_clustered_1 = np.where((x_clustered == 1), x_clustered, -1)
x_clustered_2 = np.where((x_clustered == 2), x_clustered, -1)
...
with rasterio.open('k-means-mndsi-3_1.tif', 'w', **profile) as tiff:
